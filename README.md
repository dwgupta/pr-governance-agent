...
If you submit an already-merged PR in **auto** mode, the agent shows a warning (*PR is already merged — please validate your input*) and skips approve/merge (`auto_skipped_already_merged`).
